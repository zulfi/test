...
public class RdpTunnel extends HttpTunnel {

	private Logger _logger = Logger.getLogger(RdpTunnel.class);
	...
	protected GuacamoleTunnel doConnect(HttpServletRequest request) throws GuacamoleException {
		...
		if ("rdp".equals(protocol)) {
			try{
				...
				config.setParameter("password", "CliQrWin2day!");//can be overridden using rdp.properties
				config.setParameter("username", "cliqr");//always for now
